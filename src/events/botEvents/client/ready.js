...
module.exports.run = async (client) => {
    ...
    setInterval(async () => {
        ...
        const status = [
            { type: ActivityType.Listening, name: "bangers!" },
            { type: ActivityType.Listening, name: "at Youtube! ❤️" },
            { type: ActivityType.Listening, name: "at Spotify! 💚" },
            { type: ActivityType.Listening, name: "at Soundcloud! 🧡" },
            { type: ActivityType.Listening, name: "/play" },
            { type: ActivityType.Listening, name: "at the gym! 💪" },
            { type: ActivityType.Listening, name: "LOFI ☕" },
            { type: ActivityType.Playing, name: `On ${servers} Servers` },
